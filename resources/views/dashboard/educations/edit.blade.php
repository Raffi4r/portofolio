...
@section('content')
    ...
    <form action="{{ route('educations.update', $data->id) }}" method="POST" id="expForm">
        @csrf
        @method('PUT')
        <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-md @error('title') is-invalid @enderror" name="title"
                id="title" aria-describedby="helpId" placeholder="University" value="{{ $data->title }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-md @error('info1') is-invalid @enderror" name="info1"
                id="info1" aria-describedby="helpId" placeholder="Faculty" value="{{ $data->info1 }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-md @error('info2') is-invalid @enderror" name="info2"
                id="info2" aria-describedby="helpId" placeholder="Major" value="{{ $data->info2 }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-md @error('info3') is-invalid @enderror" name="info3"
                id="info3" aria-describedby="helpId" placeholder="GPA (max 4.00)" value="{{ $data->info3 }}">
                ...
                <div class="column">
                    ...
                    <div>
                        <input type="date" class="form-control form-control-sm @error('date_start') is-invalid @enderror"
                            name="date_start" id="date_start" onkeydown="return false" value="{{ $data->date_start }}">
                ...
                <div class="column">
                    ...
                    <div class="col-auto">
                        <input type="date" class="form-control form-control-sm @error('date_end') is-invalid @enderror"
                            id="date_end" name="date_end" onkeydown="return false" value="{{ $data->date_end }}">
    ...
    <script>
        $(function() {
            ...
            function validateForm() {
                ...
                if (info3Input.val() > 0 && info3Input.val() <= 4)
