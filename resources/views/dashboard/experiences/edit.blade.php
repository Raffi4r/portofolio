...
@section('content')
    ...
    <form action="{{ route('experiences.update', $data->id) }}" method="POST" id="expForm">
        @csrf
        @method('PUT')
        <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-md @error('info1') is-invalid @enderror" name="info1"
                id="info1" aria-describedby="helpId" placeholder="Company" value="{{ $data->info1 }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-md @error('title') is-invalid @enderror" name="title"
                id="title" aria-describedby="helpId" placeholder="Position" value="{{ $data->title }}">
        ...
        <div class="mb-3">
            ...
            <textarea class="ckeditor" rows="5" name="description" id="editor" data-validation="required">{{ $data->description }}</textarea>
...
@section('script')
    <script>
        $(function() {
            ...
            if ("{{ $data->date_end }}" === '') {
                date_endInput.prop('disabled', true);
                presentInput.prop('checked', true);
            }
